...
func (o *OrderRepo) Create(ord *models.OrderCreate) (*models.Order, error) {
...
func (o *OrderRepo) GetList(ord *models.OrderGetListRequest) (*models.OrderGetListResponse, error) {
	var resp = &models.OrderGetListResponse{}
...
func (o *OrderRepo) Update(ord *models.OrderUpdate) (*models.Order, error) {
...
func (o *OrderRepo) AddOrderItem(req *models.OrderItemCreate) error {
...
func (o *OrderRepo) RemoveOrderItem(req *models.OrderItemPrimaryKeyRemove) error {
